...
class RestaurantReservationSystem:
    ...
    # def sumReports(self):
    # print("Total number of adults:", sum([i[4] for i in self.report_list]))  # sum of adults
    # print("Total number of kids:", sum([i[5] for i in self.report_list]))  # sum of children
    # print("Grand Total: PHP", sum([i[6] for i in self.report_list]))  # sum of subtotal
...
try:
    ...
    print("""\nPLEASE TRY AGAIN WITH APPROPRIATE ENTRIES.
        ...
        -Cancel reservations that exists.
